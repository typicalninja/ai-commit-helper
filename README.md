...
A small Node.js CLI to help generate git commit messages using Google Gemini. It's configurable, supports saving an API key, and lets you choose the model. The default model is the cheapest Gemini `fash` model.
